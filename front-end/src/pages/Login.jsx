        ...
        <div className='flex items-center justify-center flex-col h-screen bg-gradient-to-tr from-red-400 to-red-500'>
            ...
            <form className='flex flex-col items-center p-8 rounded bg-slate-100'>
                <div className='flex flex-col items-center gap-2 relative'>
                    <input className="w-72 px-3 py-2 rounded border-gray-300 border-[2px]" type="text" placeholder='username' />
                    <input className="w-72 px-3 py-2 rounded border-gray-300 border-[2px]" type="password" placeholder='password' />
